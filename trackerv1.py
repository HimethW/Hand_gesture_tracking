  ...
  while cap.isOpened():
    ...
    if recognition_result_list:
      ...
      for hand_index, hand_landmarks in enumerate(
        ...
        #calling a custom function based on the hand index and category name
        if handedness == 'Right':
          match (category_name):
            case 'Open_Palm':
              print("open palm detected left hand")
            case 'Closed_Fist':
              print("closed_fist detected left hand")
            case 'Thumb_Up':
              print("thumbs_Up detected left hand")
            case 'Victory':
              print("victory detected left hand")
            case 'Pointing_Up':
              print("pointing up detected left hand")
        elif handedness == 'Left':
          match (category_name):
            case 'Open_Palm':
              print("open palm detected right hand")
            case 'Closed_Fist':
              print("closed_fist detected right hand")
            case 'Thumb_Up':
              print("thumbs_Up detected right hand")
            case 'Victory':
              print("victory detected right hand")
            case 'Pointing_Up':
              print("pointing up detected right hand")
